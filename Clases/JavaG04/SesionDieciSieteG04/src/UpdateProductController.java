    ...
    void consultar(ActionEvent event) {
        ...
        try {
            ...
            if (result.next()) {
                ...
                txtAPCompra.setText(String.valueOf(result.getInt("precio_compra")));
                txtAPVenta.setText(String.valueOf(result.getInt("precio_venta")));
                txtACBodega.setText(String.valueOf(result.getInt("cant_bodega")));
                txtACMin.setText(String.valueOf(result.getInt("cant_min_requerida")));
                txtACMax.setText(String.valueOf(result.getInt("cant_max_inv_permitida")));
            }
            editarCajas();
